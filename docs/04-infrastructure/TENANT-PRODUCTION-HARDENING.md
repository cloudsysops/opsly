...
> **Canónico (infra):** editar este archivo. Stub: [`docs/TENANT-PRODUCTION-HARDENING.md`](../TENANT-PRODUCTION-HARDENING.md).

Controles de seguridad y trazabilidad que deben mantenerse en **producción multi-tenant**. Complementa [`docs/SECURITY_CHECKLIST.md`](./SECURITY_CHECKLIST.md) y [`docs/04-infrastructure/SECURITY-MITIGATIONS-2026-04-09.md`](./SECURITY-MITIGATIONS-2026-04-09.md).

...
// Returns:
{
  context: "<context_bundle>
    <context_file source='docs/SOCIAL-MEDIA-AGENT-SYRA.md'>
      ...26.6 KB of Syra docs...
    </context_file>
    <context_file source='docs/SYRA-IMPLEMENTATION-GUIDE.md'>
      ...10.6 KB of implementation...
    </context_file>
  </context_bundle>",
  cache_hit: false,
  sources: ['docs/SOCIAL-MEDIA-AGENT-SYRA.md', 'docs/SYRA-IMPLEMENTATION-GUIDE.md'],
  digest: 'sha256(query)'
}
```

...
- ✅ **Traefik routing**: API pública `https://api.op-sly.com/api/health` FUNCIONANDO ✅
...
- ✅ **jkboterolabs** (JK Botero Labs) - slug `jkboterolabs`, plan `startup`
  ...
  - Uptime Kuma: `https://uptime-jkboterolabs.op-sly.com/` ✅
...
- ✅ Health check: `https://api.op-sly.com/api/health` → 200 OK
- ⚠️ **POST /api/invitations**: falla 500 (dominio Resend no verificado)
  - Error: "You can only send testing emails to your own email address"
  - Requiere: verificar dominio `op-sly.com` en Resend
...
- [ ] **Resend dominio**: verificar `op-sly.com` para envíos reales

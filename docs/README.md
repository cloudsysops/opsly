...
| [LEGALVIAL-LOCALRANK-MODEL.md](runbooks/LEGALVIAL-LOCALRANK-MODEL.md) | LegalVial subcliente de LocalRank — matriz y contrato |
| [LEGALVIAL-GOLIVE-CHECKLIST.md](runbooks/LEGALVIAL-GOLIVE-CHECKLIST.md) | Checklist go-live LegalVial |
| [SUBCLIENT-ONBOARDING-TEMPLATE.md](runbooks/SUBCLIENT-ONBOARDING-TEMPLATE.md) | Plantilla onboarding subcliente / tenant hijo |

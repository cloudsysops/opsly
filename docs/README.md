...
| [`runbooks/LEGALVIAL-LOCALRANK-MODEL.md`](runbooks/LEGALVIAL-LOCALRANK-MODEL.md)       | LegalVial como subcliente de LocalRank (matriz compartido/dedicado)        |
| [`runbooks/LEGALVIAL-CONFIG-ZERO-TRUST.md`](runbooks/LEGALVIAL-CONFIG-ZERO-TRUST.md)   | Config, secretos Doppler y zero-trust (portal/jobs) para LegalVial         |
| [`runbooks/LEGALVIAL-GOLIVE-CHECKLIST.md`](runbooks/LEGALVIAL-GOLIVE-CHECKLIST.md)   | Checklist técnico-operativo go-live LegalVial                              |
| [`runbooks/LEGALVIAL-E2E-SOFTLAUNCH.md`](runbooks/LEGALVIAL-E2E-SOFTLAUNCH.md)         | Smoke E2E, soft-launch y criterios de rollback                             |
| [`runbooks/SUBCLIENT-ONBOARDING-TEMPLATE.md`](runbooks/SUBCLIENT-ONBOARDING-TEMPLATE.md) | Plantilla reusable para subclientes bajo un tenant padre               |

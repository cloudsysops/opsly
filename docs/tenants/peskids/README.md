...
## Reusable outputs for future platforms

- Auth y roles: staff por invitación; familias/clientes con login simple y tenant isolation.
- UX base: landing, dashboards, forms, submissions y approval-first messaging.
- Operación: extraction checklist, provisioning standard, rollback y handoff.
- Seguridad: backend zero-trust, RLS por tenant y trazabilidad por aprobación.
- Documento de salida: [EXTRACTION-PLAN.md](./EXTRACTION-PLAN.md) como patrón para cualquier nueva plataforma.

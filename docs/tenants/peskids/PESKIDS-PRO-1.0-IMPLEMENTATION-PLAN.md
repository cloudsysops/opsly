...
| **PR-PRO-2** (este) | Email de confirmación (Resend u otro ya adoptado) | Tabla `platform.peskids_lead_email_deliveries` (pending/sent/failed/skipped) + idempotency key |

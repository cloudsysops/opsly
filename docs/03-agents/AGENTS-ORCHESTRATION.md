...
3. Revisión con `docs/generated/sprint-status.auto.md` (y `docs/01-development/SPRINT-TRACKER.md` para vista humana).
...
| `docs/01-development/SPRINT-TRACKER.md`                       | Vista humana del sprint — no lo sobrescribe `docs:sync` |

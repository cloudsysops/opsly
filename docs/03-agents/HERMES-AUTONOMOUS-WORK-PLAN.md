...
| Tier 3 — troubleshooting | `docs/runbooks/TROUBLESHOOTING-GUIDE.md` y `docs/01-development/TROUBLESHOOTING.md` |
| Tier 3 — E2E | `docs/testing/E2E-TEST-SCENARIOS.md` y alias `docs/testing/E2E-TEST-SCENARIOS.md` |
| Tier 4 — scripts | `scripts/daily-health-check.sh`, `scripts/performance-test.sh` |
| Tier 4 — wireframes costes | `docs/01-development/COST-DASHBOARD-WIREFRAMES.md` (no `docs/design/COST-DASHBOARD-WIREFRAME.md`) |
...
docs/runbooks/TROUBLESHOOTING-GUIDE.md (guía principal)
...
**Deliverables:**
- `docs/testing/E2E-TEST-SCENARIOS.md` y `docs/testing/E2E-TEST-SCENARIOS.md` (alias)
...
**Deliverables:**
- `docs/01-development/COST-DASHBOARD-WIREFRAMES.md`

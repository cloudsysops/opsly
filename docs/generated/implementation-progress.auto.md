...
| Campo               | Valor                    |
| ------------------- | ------------------------ |
| Generado (ISO)      | 2026-04-26T17:46:14.986Z |
...
| Doppler Secrets (GCP)         | ⏳ PENDING | GCLOUD*\* / GOOGLE*\* + VERTEX_AI_EMBED_ENABLED en prd.                              | [docs/VERTEX-AI-SETUP.md](docs/VERTEX-AI-SETUP.md)                                                             |
...
- **Severity:** CRITICAL
- **Status:** OPEN
- **Fix:** Seguir docs/VERTEX-AI-SETUP.md; doppler secrets set GCLOUD\_\* y JSON SA.
...
_Última generación local/CI: 2026-04-26T17:46:14.986Z_

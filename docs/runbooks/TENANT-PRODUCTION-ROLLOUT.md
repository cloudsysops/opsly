...
> **Canónico (runbooks):** editar este archivo. Stub: [`docs/TENANT-PRODUCTION-ROLLOUT.md`](../TENANT-PRODUCTION-ROLLOUT.md).
...
(Ajustar nombres según `docs/04-infrastructure/TENANT-PRODUCTION-BASELINE.md`.)
...
- [OPERATIONS-HANDBOOK.md](./OPERATIONS-HANDBOOK.md) (si aplica procedimiento VPS)

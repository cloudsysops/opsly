...
- `docs/04-infrastructure/MCP-ORCHESTRATOR-DEPLOYMENT.md` - How to use

### Architecture
- `docs/adr/ADR-029-mcp-orchestration.md` - Design decisions
- `docs/03-agents/AGENT-PROMPTS-REFERENCE.md` - Agent capabilities
- `docs/03-agents/IMPLEMENTATION-MCP-AGENTS.md` - Technical details

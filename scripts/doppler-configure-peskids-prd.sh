...
echo ""
echo "Twenty CRM (when cutting over from GHL):"
echo "  ./scripts/tenants/bootstrap-twenty.sh --execute-secrets --skip-compose"
echo "  ./scripts/tenants/doppler-configure-twenty-prd.sh --tenant peskids"
echo "  docs/tenants/peskids/TWENTY-CRM.md"

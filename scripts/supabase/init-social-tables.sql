-- Standalone init script for social_posts tables.
-- Canonical migration: supabase/migrations/0053_social_reels_automation.sql
-- Usage: psql $SUPABASE_DATABASE_URL < scripts/supabase/init-social-tables.sql

...
function generateHashtags(theme, language, streamerName) {
...
async function generateDailyReel() {
  const streamer = pickRandom(FAMOUS_STREAMERS);
  const theme = pickRandom(OPSLY_THEMES);
  const language = Math.random() < 0.66 ? 'es' : 'en';

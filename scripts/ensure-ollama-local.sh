...
#   OLLAMA_GPU=1          agrega infra/docker-compose.opslyquantum.gpu.yml como
#                         override (passthrough NVIDIA); solo en hosts con GPU
#                         real y NVIDIA Container Toolkit instalado.
#
set -euo pipefail

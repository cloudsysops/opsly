...
def cmd_performance(args):
    ...
    if args.record:
        tracker.record(args.provider, args.task, int(args.latency), 
                     args.success.lower() == 'true', float(args.cost))
...
def cmd_budget(args):
    ...
    if args.set:
        controller.set_budget(args.tenant, float(args.amount), 
                             args.alert_threshold, args.hard_limit)
        ...
        controller.record_cost(args.tenant, float(args.cost), 
                              args.provider, args.task_type)
...
def main():
    ...
    p_provider.add_argument('--adjust', action='store_true', help='Adjust provider weight')
    ...
    p_evol.add_argument('--analyze', action='store_true', help='Analyze and generate ideas')

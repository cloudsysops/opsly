...
- [ ] **Producción:** si toca `apps/` / `infra/` / deploy / migraciones → staging verificado y promoción en ventana (`America/Bogota` 22:00–06:00); `safe-daytime` solo para cambios sin impacto runtime ([runbook](../docs/runbooks/PESKIDS-RELEASE-PIPELINE.md))

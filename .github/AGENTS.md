...
21. **Siguiente** — p. ej. más rutas bajo `/api/portal/tenant/[slug]/`, E2E invite, u operación VPS según `VISION.md`.
...
| OpenAPI (subset) | `docs/openapi-opsly-api.yaml` — portal: `/api/portal/me`, `/mode`, `/usage`, `/tenant/{slug}/me|mode|usage` (incr. 20, 2026-04-08) |
...
20. **Siguiente capacidad Fase 4** — más handlers bajo `/api/portal/tenant/[slug]/`, E2E invite o VPS según `VISION.md`.

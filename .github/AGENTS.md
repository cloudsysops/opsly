...
13. **Siguiente capacidad Fase 4** — elegir según `VISION.md` (p. ej. más handlers bajo `/api/portal/tenant/[slug]/`, E2E invite, u operación VPS); no listado aquí como bloqueante.

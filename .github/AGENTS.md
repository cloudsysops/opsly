...
9. **Ampliar Zero-Trust** — primera ruta `/api/portal/.../[slug]` o nuevos handlers portal — cuando se priorice (`resolveTrustedPortalSession` + `tenantSlugMatchesSession`).

-- Peskids operations MVP: PostgREST grants + RLS policies for pools/classes/enrollments/payments
-- Fixes service_role 500 on /api/admin/classes when migration 009 enabled RLS without GRANTs.

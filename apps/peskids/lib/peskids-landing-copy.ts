...
export const PESKIDS_CONSENT_TREATMENT =
  'Autorizo a Peskids para tratar mis datos personales y los datos necesarios del menor bajo mi responsabilidad, incluida la cédula del acudiente y la fecha de nacimiento, con el fin de atender esta solicitud y contactarme, conforme a su Política de Privacidad.';

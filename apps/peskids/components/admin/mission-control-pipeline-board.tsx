  ...
  return (
    <div>
      <div className="mb-4 flex items-center justify-between gap-3">
        ...
        <Link
          href="/admin/pipeline"
          className="pk-focus rounded-xl border border-pk-border bg-white px-3 py-2 text-xs font-semibold text-pk-primary hover:bg-pk-muted"
        >
              ...
              >
                ...
                <div className="flex max-h-[50vh] flex-col gap-2 overflow-y-auto p-2.5">
                  {board.columns[columnId].length === 0 ? (
                    <p className="rounded-xl border border-dashed border-pk-border bg-white/60 px-3 py-4 text-center text-[11px] text-pk-sub">
                      Sin tarjetas
                    </p>
                  ) : (
                    board.columns[columnId].map((card) => (
                      <Link
                        ...
                        className={cn(
                          'pk-focus block rounded-xl border bg-white px-3 py-2.5 text-xs shadow-sm transition-shadow hover:shadow-card-hover',

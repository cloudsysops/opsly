...
export function FormSubmission({ form, onSubmit, isLoading = false, successUrl }: FormSubmissionProps): React.ReactElement {
  ...
  const handleSubmit = async (e: React.FormEvent): Promise<void> => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'No pudimos procesar tu solicitud. Intenta de nuevo en un momento.')
    }
  }
    ...
    return (
      <div className="flex h-full min-h-[400px] items-center justify-center">
        <div className="space-y-3 text-center">
          <CheckCircle className="mx-auto h-12 w-12" style={{ color: peskidsColorTokens.status.success }} />
          <h2 className="text-2xl font-bold text-pk-ink">{form.settings.successMessage || '¡Gracias!'}</h2>

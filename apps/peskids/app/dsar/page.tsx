...
export const metadata: Metadata = {
  ...
  description: 'Ejerce tus derechos de acceso, rectificación, supresión y oposición sobre tus datos personales con Peskids.',
}
  ...
  return (
    ...
    >
      <div className="rounded-lg border-2 border-pk-primary/30 bg-pk-primary/5 p-4 text-sm">
        ...
        actualizar y suprimir los datos que Peskids tiene sobre ti o sobre tu hijo/a.
        Respondemos en máximo <strong>15 días hábiles</strong>.
      </div>
      ...
      <section>
        ...
        <ul>
          ...
          <li><strong>Supresión:</strong> pedir que eliminemos tus datos (cuando no exista obligación legal de conservarlos).</li>
          <li><strong>Oposición:</strong> oponerte a comunicaciones comerciales o tratamientos específicos.</li>
      ...
      <section>
        ...
        <ol>
          ...
          <li>Si solicitas datos de un menor: indicar nombre del menor y tu relación con él/ella (padre/madre/tutor).</li>
          <li>Cualquier detalle adicional que facilite la búsqueda de tu información.</li>
        </ol>
        <p>
          Verificaremos tu identidad antes de procesar la solicitud. El plazo de respuesta
          es de <strong>15 días hábiles</strong> a partir de la recepción.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Si consideras que tus derechos han sido vulnerados, puedes presentar una reclamación
          ante la{' '}
          <a
      ...
      <section>
        ...
        <ul>
          <li><Link href="/privacy">Política de Privacidad completa</Link></li>
          <li><Link href="/aviso-parental">Aviso de Autorización Parental</Link></li>

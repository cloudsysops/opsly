...
export const metadata: Metadata = {
  ...
  description:
    'Política de tratamiento de datos personales de Peskids, conforme a la Ley 1581 de 2012 y el Decreto 1377 de 2013 de Colombia.',
};
  ...
  return (
    ...
    >
      <section>
        ...
        <p>
          Esta política regula el tratamiento de datos personales que Peskids recolecta a través de
          su sitio web y canales de contacto, en cumplimiento de la{' '}
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            <strong>Logísticos:</strong> barrio o zona (para coordinar clases a domicilio cuando
            aplica).
          </li>
          <li>
            <strong>Del uso del servicio:</strong> conversaciones con el asistente de IA,
            preferencias de clase, fuente de referido.
          </li>
          <li>
            <strong>Técnicos:</strong> cookies de sesión de Supabase Auth (necesarias para el acceso
            al panel de administración y docentes).
          </li>
        </ul>
        <p>
          No recolectamos número de cédula del acudiente, nombre completo del menor, ni información
          médica sin consentimiento adicional y explícito.
        </p>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            <strong>Jelou S.A.S (Colombia):</strong> plataforma de mensajería (WhatsApp, email) para
            contacto con el acudiente.
          </li>
          <li>
        ...
        <p>
          ...
          antes de otorgar el consentimiento. No vendemos datos a terceros.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Como titular de los datos (o como padre/madre/tutor del menor cuyos datos tratamos), usted
          tiene los siguientes derechos conforme al artículo 8 de la Ley 1581 de 2012:
        </p>
        <ul>
          <li>
            <strong>Acceso:</strong> conocer qué datos personales suyos o de su hijo/a tenemos.
          </li>
          <li>
            <strong>Rectificación:</strong> corregir datos inexactos o incompletos.
          </li>
          <li>
            <strong>Supresión:</strong> solicitar la eliminación de sus datos cuando no exista
            obligación legal de conservarlos.
          </li>
          <li>
            <strong>Oposición:</strong> oponerse al tratamiento para finalidades de comunicaciones
            comerciales.
          </li>
          <li>
            <strong>Portabilidad:</strong> recibir una copia de sus datos en formato estructurado.
          </li>
          <li>
            <strong>Revocación del consentimiento:</strong> retirar la autorización otorgada en
        ...
        <p>
          ...
          de datos en Colombia — si considera que sus derechos han sido vulnerados.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          al artículo 7 de la Ley 1581 de 2012 y el artículo 12 del Decreto 1377 de 2013. El
          tratamiento de dichos datos requiere la{' '}
          <strong>autorización previa, expresa e informada del padre, madre o tutor legal</strong>,
          la cual se obtiene mediante el formulario de solicitud. Consulta nuestro{' '}
      ...
      <section>
        ...
        <ul>
          <li>
            Datos de prospectos sin conversión: <strong>24 meses</strong> desde el último contacto,
            luego eliminación o anonimización.
          </li>
          <li>
            Datos de estudiantes matriculados: durante la vigencia de la matrícula +{' '}
            <strong>12 meses</strong>.
          </li>
          <li>
            Registros de auditoría: <strong>5 años</strong> (obligación legal).
          </li>
          <li>
            Conversaciones del asistente de IA: <strong>90 días</strong>.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          cifrado AES-256 en reposo, TLS en tránsito, control de acceso basado en roles (RLS), y
      ...
      <section>
        ...
        <p>
          Cualquier cambio sustancial a esta política será comunicado por correo electrónico a los
          titulares registrados con al menos <strong>10 días hábiles de anticipación</strong>. La
          versión vigente siempre estará disponible en <a href="/privacy">peskids.co/privacy</a>.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Esta política se rige por las leyes de la República de Colombia. Toda controversia será
          dirimida ante los jueces competentes de la ciudad de Medellín, Colombia.
        </p>
      </section>
    </LegalPageLayout>
  );

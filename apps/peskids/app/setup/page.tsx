  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-10 space-y-8">
      ...
      <section className="rounded-xl border border-dashed border-zinc-700 p-4 space-y-2 text-xs text-zinc-500 font-mono">
        ...
        <p>OPENWA_PESKIDS_API_URL=http://openwa-peskids:2785</p>
        <p>OPENWA_PESKIDS_API_KEY=&lt;api-key&gt;</p>
        <p>OPENWA_PESKIDS_SESSION_ID=peskids</p>
        <p>OPENWA_PESKIDS_WEBHOOK_SECRET=&lt;secreto-hmac&gt;</p>

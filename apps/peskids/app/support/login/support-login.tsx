...
export function SupportLogin(): React.ReactElement {
  ...
  const destination = next.startsWith('/') ? next : '/support/dashboard'
              ...
              <div className="space-y-5">
                ...
                <div className="max-w-xl space-y-4">
                  <h1 className="text-4xl font-semibold tracking-tight text-pk-ink sm:text-5xl lg:text-6xl">
                    Entrar al panel de soporte
                  </h1>
                  <p className="max-w-lg text-base leading-7 text-pk-sub sm:text-lg">
                    Acceso separado para resolver casos, revisar conversaciones y seguir
                    seguimientos. El equipo docente y el panel administrativo siguen aparte.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="mb-6 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-pk-sub">Soporte, profes y admin se manejan por rol</p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm leading-6 text-pk-sub sm:text-base">
                  Si ya tienes una sesión activa, te llevamos al panel correcto. Si olvidaste tu
                  contraseña, puedes regenerarla desde aquí.
                </p>
              </div>

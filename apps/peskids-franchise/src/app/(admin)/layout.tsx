...
import { AdminLayoutProvider, AdminTopNav, AdminSectionSidebar } from '@/components/admin/layout';
  ...
  return (
    <AdminLayoutProvider>
      <div className="min-h-screen bg-brand-light flex flex-col">
        {/* Top navigation */}
        <AdminTopNav user={session.user} onMenuClick={() => setSidebarOpen(true)} />

        {/* Main content area with section sidebar */}
        <div className="flex-1 flex min-w-0">
          {/* Section-specific sidebar */}
          <AdminSectionSidebar isOpen={sidebarOpen} onClose={() => setSidebarOpen(false)} />

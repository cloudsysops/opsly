...
export interface AutonomousTask {
  ...
  /** Qué executor procesa esta tarea en el Maia Loop */
  executor: "cursor" | "claude-code" | "shell";
  /** Fallback si el executor principal no está disponible */
  executorFallback?: "cursor" | "claude-code" | "shell";
  priority: number;
  prUrl: string;
  description: string;

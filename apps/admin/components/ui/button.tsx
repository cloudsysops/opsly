...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ops-green disabled:pointer-events-none disabled:opacity-50 font-sans",
  {
    variants: {
      variant: {
        default:
          "bg-ops-surface border border-ops-border text-neutral-100 hover:bg-ops-border/40",
        primary:
          "bg-ops-green/15 border border-ops-green text-ops-green hover:bg-ops-green/25",
        destructive:
          "bg-ops-red/10 border border-ops-red text-ops-red hover:bg-ops-red/20",

...
function builtInCatalog(): IntegrationRow[] {
  return [
    ...
    },
    {
      ...
      notes:
        'Copilot (IDE) y Cursor son clientes humanos; este MCP orquesta Opsly, no sustituye al IDE.',
    },
    {
      id: 'notebooklm_agent',
      kind: 'mcp_tool',
...
> = {
  ...
  inputSchema: z.object({}),
  handler: async () => {
    const data = (await opslyFetch('/api/admin/docker/containers')) as DockerContainersResponse;
    return data;
  },
};

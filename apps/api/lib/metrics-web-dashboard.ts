...
export async function getWebDashboardMetricsJson(): Promise<WebDashboardMetricsJson> {
  // Bolt Optimization: Check Redis cache first to avoid eleven parallel queries
  ...
  // Background set to avoid blocking, with a 60-second TTL
  void setCache(CACHE_KEY, body, CACHE_TTL.SHORT);

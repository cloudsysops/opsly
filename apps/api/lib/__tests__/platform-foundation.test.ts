...
describe('getMissionControlFoundationReadModel caching', () => {
  it('returns cached snapshot on cache hit', async () => {
    const mockSnapshot = {
      generated_at: '2026-08-26T12:00:00.000Z',
      vps: { host: 'vps-test', status: 'healthy', api_connectivity: 'up', orchestrator_connectivity: 'up', llm_gateway_connectivity: 'up', redis_connectivity: 'up' },
      tenants: { total: 1, by_stage: { incubated_tenant: 1, mvp_validation: 0, operational_stabilization: 0, dedicated_vps: 0, independent_platform: 0, connected_client_platform: 0 }, extraction_ready: 1, items: [] },
      ...
      openclaw: { intents: [], intents_in_progress: [], recent_policy_violations: [], agent_metrics: {}, generated_at: '2026-08-26T12:00:00.000Z' },

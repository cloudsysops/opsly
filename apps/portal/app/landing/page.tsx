      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center">
          ...
          <p className="text-xl text-slate-400 mb-8 max-w-2xl mx-auto">
            Agencies: Turn workflow automation into a white-label service without hiring ops. Deploy
            n8n, monitor uptime, handle billing—all automatically.
          </p>
          <div className="flex gap-4 justify-center">
            ...
            <Button
              size="lg"
              variant="ghost"
              className="border border-slate-700 text-white hover:bg-slate-900"
            >
              Watch Demo
            </Button>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-lg p-8">
            ...
            <p className="text-slate-400">
              No Docker. No Kubernetes. No DevOps hire. Spin up n8n + Uptime Kuma per customer in
              under 5 minutes.
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-lg p-8">
            ...
            <ul className="space-y-3 mb-8">
              ...
              <li className="flex items-center gap-2 text-slate-300">
                <Check className="h-4 w-4 text-blue-400" />1 primary domain
              </li>
              <li className="flex items-center gap-2 text-slate-300">
                <Check className="h-4 w-4 text-blue-400" />
                Weekly backups
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-lg p-8">
            ...
            <Button
              variant="ghost"
              className="w-full border border-slate-700 text-white hover:bg-slate-900"
            >
              Contact Sales
            </Button>
          </div>
      ...
      <section id="trial" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg p-12 text-center">
          ...
          <p className="text-blue-100 mb-8">
            14-day free trial of Business plan. No credit card required.
          </p>
          <div className="flex gap-4 justify-center">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div>
              ...
              <p className="text-slate-400 text-sm">
                Deploy customer automation. Manage everywhere.
              </p>
            </div>
            <div>

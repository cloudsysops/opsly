...
export default async function ManagedDashboardPage(): Promise<ReactElement> {
  ...
  return (
    <PortalShell
      title={`Tus Automatizaciones - ${displayName}`}
      showModeLink
    ...
    >
      <DashboardShell>
        ...
        <div className="stagger-children space-y-8">
          ...
          {insights !== null && (
            <InsightDashboard tenantSlug={data.slug} insights={insights.insights} />
          )}
            ...
            <p className="mt-2 text-sm">
              {supportEmail.length > 0 ? (
                ...
                <span className="text-ops-gray">
                  Configura NEXT_PUBLIC_SUPPORT_EMAIL en el despliegue para mostrar el correo de
                  contacto.
                </span>
              )}
            </p>

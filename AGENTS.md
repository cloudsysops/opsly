...
15. **Siguiente** — p. ej. `POST /api/portal/tenant/[slug]/mode` con el mismo patrón Zero-Trust, o prioridad de `VISION.md` (E2E invite, VPS).
...
14. **Siguiente capacidad Fase 4** — `POST /api/portal/tenant/[slug]/mode` u otra ruta bajo `/api/portal/tenant/[slug]/`; o E2E invite / VPS según `VISION.md`.

...
17. **Siguiente** — p. ej. más rutas bajo `/api/portal/tenant/[slug]/`, E2E invite, u operación VPS según `VISION.md`.
...
16. **Siguiente capacidad Fase 4** — más handlers bajo `/api/portal/tenant/[slug]/`, E2E invite o VPS según `VISION.md`.

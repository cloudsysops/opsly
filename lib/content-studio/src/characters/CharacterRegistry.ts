/**
 * Legacy JSON character bible for opsly-origins series extras
 * (opsly-founder, messenger, …). Canonical IP is `@intcloudsysops/universe`.
 * Do not add new living characters here.
 */
